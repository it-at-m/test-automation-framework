...
public class WindowControls {
    ...
    public static void initializeWindowMap() {
        WINDOW_LIST_MAP.put(Thread.currentThread().threadId(), new LinkedList<>());
    }
    ...
    private static List<Window> getWindowList() {
        return WINDOW_LIST_MAP.get(Thread.currentThread().threadId());
    }
    ...
    public static void initializeLastActiveWindowListIndexMap() {
        LAST_ACTIVE_WINDOW_LIST_INDEX_MAP.put(Thread.currentThread().threadId(), -1);
    }
    ...
    public static void initializeActiveWindowListIndexMap() {
        ACTIVE_WINDOW_LIST_INDEX_MAP.put(Thread.currentThread().threadId(), 0);
    }
    ...
    public static void updateWindowList(RemoteWebDriver driver, WindowType expectedWindowType) {
        ...
        if (getIndexOfActiveWindow() != indexOfActiveWindow) {
            if (getWindowList().size() < 2) {
                LAST_ACTIVE_WINDOW_LIST_INDEX_MAP.replace(Thread.currentThread().threadId(), -1);
            } else {
                LAST_ACTIVE_WINDOW_LIST_INDEX_MAP.replace(Thread.currentThread().threadId(), getIndexOfActiveWindow());
            }
            ACTIVE_WINDOW_LIST_INDEX_MAP.replace(Thread.currentThread().threadId(), indexOfActiveWindow);
        }
    }
    ...
    public static int getIndexOfActiveWindow() {
        return ACTIVE_WINDOW_LIST_INDEX_MAP.get(Thread.currentThread().threadId());
    }
    ...
    public static int getIndexOfLastActiveWindow() {
        return LAST_ACTIVE_WINDOW_LIST_INDEX_MAP.get(Thread.currentThread().threadId());
    }
    ...
    public static void clearWindowList() {
        ...
        WINDOW_LIST_MAP.remove(Thread.currentThread().threadId());
        LAST_ACTIVE_WINDOW_LIST_INDEX_MAP.remove(Thread.currentThread().threadId());
        ACTIVE_WINDOW_LIST_INDEX_MAP.remove(Thread.currentThread().threadId());
    }
