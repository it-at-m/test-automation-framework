...
public class FrameControls {
    ...
    public static Frame getCurrentFrame() {
        return CURRENT_FRAME_MAP.get(Thread.currentThread().threadId());
    }
    ...
    public static void setCurrentFrame(Frame currentFrame) {
        CURRENT_FRAME_MAP.put(Thread.currentThread().threadId(), currentFrame);
    }
    ...
    public static void setCurrentFrameUnknown() {
        CURRENT_FRAME_MAP.put(Thread.currentThread().threadId(), new Frame("unknown"));
    }
    ...
    public static void clearCurrentFrame() {
        CURRENT_FRAME_MAP.remove(Thread.currentThread().threadId());
    }
}
