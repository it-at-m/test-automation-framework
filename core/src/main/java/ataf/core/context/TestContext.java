...
public class TestContext {
    ...
    public static Test get() {
        return CURRENT_TEST_MAP.get(Thread.currentThread().threadId());
    }
    ...
    public static void set(Scenario scenario) {
        for (String sourceTag : scenario.getSourceTagNames()) {
            ...
            if (test != null) {
                CURRENT_TEST_MAP.put(Thread.currentThread().threadId(), test);
                break;
            }
        }
        CustomAssertions.assertNotNull(CURRENT_TEST_MAP.get(Thread.currentThread().threadId()),
    ...
    public static void clear() {
        CURRENT_TEST_MAP.remove(Thread.currentThread().threadId());
    }
}
