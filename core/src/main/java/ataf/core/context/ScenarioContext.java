...
public class ScenarioContext {
    ...
    public static void put(Scenario scenario) {
        SCENARIO_MAP.put(Thread.currentThread().threadId(), scenario);
    }
    ...
    public static Scenario get() {
        return SCENARIO_MAP.get(Thread.currentThread().threadId());
    }
    ...
    public static void clear() {
        SCENARIO_MAP.remove(Thread.currentThread().threadId());
    }
}
