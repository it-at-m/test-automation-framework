...
public class TestDataHelper {
    ...
    public static void initializeTestDataMap() {
        TEST_DATA_MAP.put(Thread.currentThread().threadId(), new HashMap<>());
    }
    ...
    public static String getTestData(String key) {
        return decryptTestData(TEST_DATA_MAP.get(Thread.currentThread().threadId()).get(key));
    }
    ...
    public static void setTestData(String key, String value) {
        TEST_DATA_MAP.get(Thread.currentThread().threadId()).put(key, encryptTestData(value));
    }
    ...
    public static void flushMapTestData() {
        TEST_DATA_MAP.get(Thread.currentThread().threadId()).clear();
        TEST_DATA_MAP.remove(Thread.currentThread().threadId());
    }
    ...
    public static String getTestData() {
        StringBuilder testData = new StringBuilder();
        for (Map.Entry<String, String> entry : TEST_DATA_MAP.get(Thread.currentThread().threadId()).entrySet()) {
            if (!testData.isEmpty()) {
                testData.append('\n');
            }
            testData.append(entry.getKey());
